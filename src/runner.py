...
def run(args: dict) -> dict:
    ...
    matched_spectra = identification.id_spectra(args['spectra_files'], args['database_file'], min_peptide_len=args['min_peptide_len'], 
        ...
        digest_left=args['digest_left'], digest_right=args['digest_right'], n=args['n'] * 10,verbose=True, DEBUG=args['DEBUG'], cores=cores, make_new = args["new_db"], output_dir=args['output_dir'])
