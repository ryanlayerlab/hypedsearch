...
# I wonder if these problematic hits are existing in our overlapped boundaries
target_mass = 243.13357543945312
mapped = mz_mapping[target_mass]
b = boundaries[mapped]

tol = ppm_to_da(target_mass, ppm_tolerance)
bound = [target_mass - tol, target_mass + tol]
print(b, bound)




addscore = testing_utils.test_optimized_compare_masses(mz_mapping, boundaries, input_mz, b_spec, 20, False)
print(addscore)