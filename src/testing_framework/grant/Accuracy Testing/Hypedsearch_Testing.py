...
# input_spectra = [hybrid_spectra[6]]
# correct_sequences = [hybrid_correct_seqs[6]]
...
for spectrum_num,input_spectrum in enumerate(input_spectra):
    ...
    merged_top = combine_merges(merged_seqs, hybrid_merged)
    ...
    ss_time = time.time()
    rescored_alignments = second_scoring(alignments, input_spectrum, tol)
