...
ExperimentParameters = namedtuple('ExperimentParameters',['id','precurors','sqllite_database', 'max_peptide_length','ppm_tolerance','precursor_tolerance','number_hybrids','number_natives','target_seq'])
KMer = namedtuple('KMer',['fragment_mass','protein_id','location_start','location_end','sequence','ion','charge','score','kmer_type'])
